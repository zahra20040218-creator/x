...
| **Account deletion** | **ABSENT** | Play requires an in-app path or a web form. Neither exists, and there is no `DELETE /me` in the contract. **This blocks publication** — see `docs/PLAY_LISTING.md` | — | — | **not implemented** |
