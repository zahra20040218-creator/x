...
plugins {
    ...
    // Firebase. Must come before the Flutter plugin so the generated resources
    // exist by the time Flutter's own tasks run.
...
android {
    namespace = "iq.rideapp.rideapp_driver"
    ...
    defaultConfig {
        ...
        applicationId = "iq.rideapp.rideapp_driver"
