...
| P2 | D-19 | open | `pnpm seed` points at `src/db/seed.ts`, which does not exist. Seed data is referenced by CLAUDE.md 11 and by the setup docs; the script has never been runnable. Recorded rather than invented - writing seed data is a product decision about what a fresh environment should contain |
